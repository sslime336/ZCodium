...
`,
  ...
  tui: {
    ...
    modelSetupRequired: {
      help: "Use /model to view models, or configure a provider API key in settings.",
      message: "No available models. Configure a provider API key to start.",
      status: "No available models. Configure a provider API key to start.",
